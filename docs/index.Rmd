...
p <- get_prior(Concern ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)

p$prior[1] <- "normal(0,1)"
p$prior[c(14,15,16,17,18)] <- "dirichlet(2)"

m3 <- brm(
  Concern ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  # sample_prior = "only",
  data = d
...
# NThe only predictor having any effect on the outcome is the device which have negative effect

p <- get_prior(Trust_Family ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m4 <- brm(
  Trust_Family ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Trust_Scientist ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)

p$prior[1] <- "normal(0,1)"
p$prior[c(15,16,17,18,19)] <- "dirichlet(2)"

m5 <- brm(
  Trust_Scientist ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
# Age seem to have a slight negative impact 

p <- get_prior(Trust_Government ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m6 <- brm(
  Trust_Government ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m6, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Trust_EnergySupp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m7 <- brm(
  Trust_EnergySupp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m7, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Trust_Environmental ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m8 <- brm(
  Trust_Environmental ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m8, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Trust_Application ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m9 <- brm(
  Trust_Application ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m9, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Trust_Media ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m10 <- brm(
  Trust_Media ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m10, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Trust_Internet ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m11 <- brm(
  Trust_Internet ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m11, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
# NrOfSub, ActiveDev as well as DaysAWeek seem to have a negative effect on the outcome whereas Gender as well as HoursADay seem to hae a positive effect on the outcome, neither of the predictors are significant
# All predictors has some effect

p <- get_prior(Trust_GiveUp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)

p$prior[1] <- "normal(0,0.5)"
p$prior[c(16,17,18,19,20)] <- "dirichlet(2)"

m12 <- brm(
  Trust_GiveUp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
# Age, Gender, Device, ActiveDev and HoursADay have a positive impact on the outcome, NrOfSubs have a negative impact on the outcome

p <- get_prior(Act_WalkCycle ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m13 <- brm(
  Act_WalkCycle ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Act_TurnOffLights ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m14 <- brm(
  Act_TurnOffLights ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m14, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Act_Recycle ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m15 <- brm(
  Act_Recycle ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m15, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Act_Veggie ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m16 <- brm(
  Act_Veggie ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m16, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Act_Computer ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m17 <- brm(
  Act_Computer ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m17, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Act_Showers ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m18 <- brm(
  Act_Showers ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Act_SecondHand ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m19 <- brm(
  Act_SecondHand ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(MainResp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m20 <- brm(
  MainResp ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Motivate_Notif ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)

p$prior[1] <- "normal(0,1)"
p$prior[c(17,18,19,20,21)] <- "dirichlet(2)"

m21 <- brm(
  Motivate_Notif ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m21, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
# DaysAWeek does have slight impact on the outcome

p <- get_prior(Motivate_Information ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m22 <- brm(
  Motivate_Information ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m22, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Motivate_SetGoals ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m23 <- brm(
  Motivate_SetGoals ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m23, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Motivate_Nothing ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m24 <- brm(
  Motivate_Nothing ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Motivate_LoggingUse ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m25 <- brm(
  Motivate_LoggingUse ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Motivate_Blocking ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m26 <- brm(
  Motivate_Blocking ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
mcmc_areas(m26, prob = 0.5, prob_outer = 0.95, regex_pars = c("^b_A", "^b_G", "^bsp"))
...
p <- get_prior(Motivate_Impact ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m27 <- brm(
  Motivate_Impact ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
...
p <- get_prior(Motivate_Suggestions ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  data = d)
...
m28 <- brm(
  Motivate_Suggestions ~ 1 + Age_s + Gender + mo(NrOfSub) + mo(Device) + mo(ActiveDev) + mo(DaysAWeek) + mo(HoursADay),
  family = cumulative(),
  prior = p,
  data = d
)
